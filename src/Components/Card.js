  ...
  return (
    <div key={post.id}  className='card' style={{ border: "1px solid black", margin: "10px" }}>
          ...
          <div className='buttonDivision'>
            <button style={{ display: "inline", margin:"10px" ,height:'30px', backgroundColor:'blue',cursor:"pointer"}} onClick={() => editFunc(post)}>
                Edit
            </button>
            <button
                style={{ display: "inline",margin:'10px',height:'30px',backgroundColor:"Tomato",cursor:"pointer" }}
